    ...
    <div class="row g-0">
      ...
      <form method="Post">
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control" name="nome_ptc" value = "<?php echo($ptc->nome_ptc);?>"  id="nomeparticipante" placeholder="João da Silva">
        </div>

        <div class="mb-3">
          <label for="dnparticipante" class="form-label">Data de nascimento</label>
          <input type="text" class="form-control" name="dtn_ptc" value = "<?php echo($ptc->dt_nascptc);?>" id="dnparticipante" placeholder="12/12/2000">
        </div>
        ...
        <div class="mb-3">
          ...
          <?php echo($ptc->status_ptc);?>
           </textarea>
        </div>


    <button type="submit" class="btn btn-primary btn-lg mt-4">Alterar dados</button>
      </form>
      </div>

      <div class="col-12 col-md-3 bg-danger">
      <button class="btn btn-primary"> <a href="<?php echo site_url('UsuarioController/logout')?>">Sair</a></button>
      <p>Seja bem vindo: <?php echo($session->login_usu);?></p>
      </div>
    </div>
