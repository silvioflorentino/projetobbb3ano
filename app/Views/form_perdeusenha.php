...
<div class="container">
<form action="<?= base_url("UsuarioController/confemail")?>" method="POST">

  <div class="mb-3">
    <label for="exampleInputEmail1" class="form-label">Email</label>
    <input type="email" autocomplete="off" name="login_usu" class="form-control" id="exampleInputEmail1"  aria-describedby="emailHelp">
